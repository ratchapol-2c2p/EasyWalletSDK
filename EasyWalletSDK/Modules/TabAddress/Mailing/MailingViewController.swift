...
class MailingViewController: BaseViewController {
    
    @IBOutlet weak var MailingAddressView: CustomTextField!
    ...
    private func setupUI() {
        ...
        MailingAddressView.setTitleText("Mailing Address")
        MailingAddressView.setPlaceholderText("Please enter Mailing Address")
    ...
    @IBAction func onTouchAcceptCheckBoxButton(_ sender: Any) {
        
        isChecked.toggle()
        let checkBoxActive = UIImage(imageNames: .checkActiveIcon)
        let checkBoxInActive = UIImage(imageNames: .checkInActiveIcon)
        checkAcceptImageView.image = isChecked ? checkBoxActive:checkBoxInActive
        infomationView.isHidden = isChecked
    }
    ...
    @IBAction func onTouchNextButton(_ sender: Any) {
        ...
        NotificationCenter.default.post(
            name: Notification.Name(AddressType.mailing.rawValue),
...
extension MailingViewController: UIViewControllerTransitioningDelegate {
