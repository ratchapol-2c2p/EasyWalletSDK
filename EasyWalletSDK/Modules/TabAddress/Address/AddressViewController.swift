...
class AddressViewController: BaseViewController{
    ...
    @IBOutlet weak var thaiIdCardView: CustomTextField!
    ...
    private func setupUI() {
        ...
        thaiIdCardView.setTitleText("Thai ID Card Address")
        thaiIdCardView.setPlaceholderText("Please enter your Thai ID Card Address")
    ...
    @IBAction func onTouchNextButton(_ sender: Any) {
        ...
        NotificationCenter.default.post(
            name: Notification.Name(AddressType.homeAddress.rawValue),
...
extension AddressViewController: UIViewControllerTransitioningDelegate {
